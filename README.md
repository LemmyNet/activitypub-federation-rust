...
- **Censorship resistance**: Current social media platforms are under the control of a few corporations and are actively being censored as revealed by the [credible journalists](https://www.businessinsider.com/twitter-leaked-internal-message-suggests-musk-ordered-leftwing-account-freeze-2023-1). This would be much more difficult on a federated network, as it would require the cooperation of every single instance administrator. Additionally, users who are affected by censorship can create their own websites and stay connected with the network.
